...
echo ""
echo "🚀 Starte circuitbreaker-Baseline-Test (backend-a + backend-b) mit JMeter + Ressourcenmonitoring"
...
RESULT_DIR="results/circuitbreaker_${timestamp_full}"
mkdir -p "$RESULT_DIR"
...
# 7. Zusammenfassung
echo ""
echo "✅ circuitbreaker-Test abgeschlossen in ${duration} Sekunden."
